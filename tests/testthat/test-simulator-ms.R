...
", file = sim_output);
  ...
  trees <- parse_ms_trees(list(sim_output), 2)
  ...
  trees <- parse_ms_trees(list(sim_output, sim_output), 4)
  expect_equal(length(trees), 4)
  expect_equal(trees[[1]], trees[[3]])
  expect_equal(trees[[2]], trees[[4]])

  trees_2 <- parse_ms_trees(list(c(sim_output, sim_output)), 4)
  expect_equal(trees, trees_2)

  trees <- parse_ms_trees(list(c(sim_output, sim_output),
                               c(sim_output, sim_output)), 8)
  expect_equal(length(trees), 8)
