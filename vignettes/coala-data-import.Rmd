...
the internal formats of other R packages into its own format. Currently, only
...
The R package PopGenome provides functions for reading various data formats, including `vcf` 
and `fasta`. Please refer to its documentation for detailed instructions. As example,
