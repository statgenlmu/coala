...
Note: As of Mai 2018, `PopGenome` is archived on CRAN. To run the code below,
you need to manually install its last version from 
[the CRAN archives](https://cran.r-project.org/src/contrib/Archive/PopGenome).
